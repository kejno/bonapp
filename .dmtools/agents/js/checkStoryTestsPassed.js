...
function action(params) {
    ...
    try {
        ...
        if (totalTCs === 0) {
            // A Story only reaches "In Testing" after story_test_automation has already
            ...
            jira_post_comment({
                key: ticketKey,
                comment: 'h3. ✅ Story Complete — No Test Cases Required\n\n' +
                    'Test automation ran and created no linked Test Cases for this Story ' +
                    '(no observable behavior to verify).\n\n' +
                    'The story has been automatically moved to *Done*.'
            });

            console.log('✅ Story', ticketKey, 'moved to Done (no test cases required)');
            ...
            return { success: true, action: 'moved_to_done_no_test_cases', ticketKey };
        }
