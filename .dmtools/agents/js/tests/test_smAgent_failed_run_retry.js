...
const storyRework = rules.find((r) => r.configFile === 'agents/story_test_automation_rework.json');
...
assert(storyReview.jql.includes("'test_pr_rework_needed'"));
assert(rules.indexOf(storyRework) < rules.indexOf(storyReview));
